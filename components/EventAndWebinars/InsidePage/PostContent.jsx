...
import Banner from "@/components/EventAndWebinars/InsidePage/Banner";
...
export default function PostContent({ slug }) {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await fetch(`https://docs.aarnalaw.com/wp-json/wp/v2/webinars_and_events?_embed&slug=${slug}`);
    ...
    return (
        <>
            ...
            <div className="mx-auto w-11/12 pb-12">
                <Link href="/event-and-webinars/" className="mt-6 bg-custom-red px-4 py-2 text-white">
